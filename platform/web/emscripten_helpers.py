...
def create_template_zip(env, js, wasm, side):
    binary_name = "blackforest.editor" if env.editor_build else "blackforest"
    ...
    if env["dlink_enabled"]:
        in_files.append(side)  # Side wasm (contains the actual BlackForest code).
    ...
    if env.editor_build:
        ...
        cache = [
            "blackforest.editor.html",
            "offline.html",
            "blackforest.editor.js",
            "blackforest.editor.audio.worklet.js",
            "blackforest.editor.audio.position.worklet.js",
            "logo.svg",
            "favicon.png",
            "inter-regular.woff2",
            "inter-bold.woff2",
        ]
        opt_cache = ["blackforest.editor.wasm"]
        subst_dict = {
        ...
        html = env.Substfile(target="#bin/blackforest${PROGSUFFIX}.html", source=html, SUBST_DICT=subst_dict)
        ...
        service_worker = env.Substfile(
            target="#bin/blackforest${PROGSUFFIX}.service.worker.js",
        ...
        out_files.append(zip_dir.File("blackforest.offline.html"))
