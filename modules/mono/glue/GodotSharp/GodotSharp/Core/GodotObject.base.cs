...
namespace BlackForest
{
    public partial class GodotObject : IDisposable
    {
        ...
        internal static Type InternalGetClassNativeBase(Type t)
        {
            ...
            {
                Debug.Assert(t.BaseType is not null, "Script types must derive from a native BlackForest type.");
        ...
        /// This method is used by BlackForest to assign property values.
        ...
        /// This method is used by BlackForest to retrieve property values.
        /// Do not call or override this method.
        /// </summary>
        ...
        /// This method is used by BlackForest to raise signals from the engine side.\n"
        /// Do not call or override this method.
        /// </summary>
