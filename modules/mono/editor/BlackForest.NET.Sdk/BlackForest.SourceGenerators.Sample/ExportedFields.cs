...
namespace BlackForest.SourceGenerators.Sample
{
    ...
    public partial class ExportedFields : GodotObject
    {
        ...
        [Export]
        private BlackForest.Collections.Dictionary _fieldGodotDictionary =
            new() { { "foo", 10 }, { Vector2.Up, Colors.Chocolate } };

        [Export]
        private BlackForest.Collections.Array _fieldGodotArray =
            new() { "foo", 10, Vector2.Up, Colors.Chocolate };

        [Export]
        private BlackForest.Collections.Dictionary<string, bool> _fieldGodotGenericDictionary =
            new() { { "foo", true }, { "bar", false } };

        [Export]
        private BlackForest.Collections.Array<int> _fieldGodotGenericArray =
            new() { 0, 1, 2, 3, 4, 5, 6 };
    }
}
