...
#pragma warning disable CS0109 // Disable warning about redundant 'new' keyword
    ...
    public new class PropertyName : global::BlackForest.GodotObject.PropertyName {
        ...
        /// </summary>
        public new static readonly global::BlackForest.StringName @WriteOnlyProperty = "WriteOnlyProperty";
        /// <summary>
        ...
        /// </summary>
        public new static readonly global::BlackForest.StringName @_writeOnlyBackingField = "_writeOnlyBackingField";
    }
    /// <inheritdoc/>
    ...
    protected override bool SetGodotClassPropertyValue(in godot_string_name name, in godot_variant value)
    {
        if (name == PropertyName.@WriteOnlyProperty) {
            this.@WriteOnlyProperty = global::BlackForest.NativeInterop.VariantUtils.ConvertTo<bool>(value);
            return true;
        }
        if (name == PropertyName.@_writeOnlyBackingField) {
            this.@_writeOnlyBackingField = global::BlackForest.NativeInterop.VariantUtils.ConvertTo<bool>(value);
            return true;
        }
    ...
    protected override bool GetGodotClassPropertyValue(in godot_string_name name, out godot_variant value)
    {
        ...
        if (name == PropertyName.@_writeOnlyBackingField) {
            value = global::BlackForest.NativeInterop.VariantUtils.CreateFrom<bool>(this.@_writeOnlyBackingField);
            return true;
        }
    ...
    internal new static global::System.Collections.Generic.List<global::BlackForest.Bridge.PropertyInfo> GetGodotPropertyList()
    {
        ...
        properties.Add(new(type: (global::BlackForest.Variant.Type)1, name: PropertyName.@_writeOnlyBackingField, hint: (global::BlackForest.PropertyHint)0, hintString: "", usage: (global::BlackForest.PropertyUsageFlags)4096, exported: false));
        properties.Add(new(type: (global::BlackForest.Variant.Type)1, name: PropertyName.@WriteOnlyProperty, hint: (global::BlackForest.PropertyHint)0, hintString: "", usage: (global::BlackForest.PropertyUsageFlags)4096, exported: false));
        return properties;
    }
