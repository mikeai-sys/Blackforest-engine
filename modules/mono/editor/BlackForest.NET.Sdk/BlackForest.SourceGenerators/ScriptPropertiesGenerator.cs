...
namespace BlackForest.SourceGenerators
{
    ...
    public class ScriptPropertiesGenerator : ISourceGenerator
    {
        ...
        )
        {
            ...
            source.Append("using BlackForest;\n");
            source.Append("using BlackForest.NativeInterop;\n");
            source.Append("\n");
            ...
            foreach (var property in godotClassProperties)
            {
                ...
                source.Append("        public new static readonly global::BlackForest.StringName @");
            ...
            if (godotClassProperties.Length > 0 || godotClassFields.Length > 0)
            {
                ...
                const string DictionaryType = "global::System.Collections.Generic.List<global::BlackForest.Bridge.PropertyInfo>";

                source.Append("    /// <summary>\n")
                    .Append("    /// Get the property information for all the properties declared in this class.\n")
                    .Append("    /// This method is used by BlackForest to register the available properties in the editor.\n")
        ...
        {
            source.Append("        properties.Add(new(type: (global::BlackForest.Variant.Type)")
                .Append((int)VariantType.Nil)
                .Append(", name: \"")
                .Append(propertyInfo.Name)
                .Append("\", hint: (global::BlackForest.PropertyHint)")
                .Append((int)PropertyHint.None)
                .Append(", hintString: \"")
                .Append(propertyInfo.HintString)
                .Append("\", usage: (global::BlackForest.PropertyUsageFlags)")
        ...
        )
        {
            ...
            if (variantType == VariantType.Object && type is INamedTypeSymbol memberNamedType)
            {
                ...
                if (memberNamedType.InheritsFrom("GodotSharp", "BlackForest.Resource"))
                {
                ...
                if (memberNamedType.InheritsFrom("GodotSharp", "BlackForest.Node"))
                {
            ...
            if (!isTypeArgument && variantType == VariantType.Dictionary)
            {
                ...
                {
                    // To maintain compatibility with previous versions of BlackForest before 4.4,
